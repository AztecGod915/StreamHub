...
const BUZZ_CACHE = "sh_sports_buzz_v8";
...
function SportsNewsTicker() {
  ...
  const PILL = {
    ...
    trending: {bg:"rgba(245,158,11,.14)",border:"rgba(245,158,11,.5)",  badge:"#F59E0B", label:"🔥 TRENDING"},
    news:     {bg:"rgba(139,92,246,.1)", border:"rgba(139,92,246,.35)", badge:"#A78BFA", label:"📰 NEWS"},
  ...
  return (
    <div style={{
      ...
      <div onClick={()=>setPaused(p=>!p)} style={{
        ...
        <span style={{fontSize:10,fontWeight:900,letterSpacing:.8,lineHeight:1.2,textShadow:"0 0 12px rgba(239,68,68,.9)"}}>⚡ SPORTS</span>
        <span style={{fontSize:10,fontWeight:900,letterSpacing:.8,lineHeight:1.2,textShadow:"0 0 12px rgba(239,68,68,.9)"}}>BUZZ</span>
...
const SPORT_CARDS = [
  { emoji:"💪", name:"WWE",        query:"WWE wrestling",          color:"#CC0000", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"Peacock",    glow:"rgba(204,0,0,.35)" },
  { emoji:"🥊", name:"UFC",        query:"UFC mixed martial arts", color:"#D20A0A", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"ESPN+",      glow:"rgba(210,10,10,.35)" },
  { emoji:"🏈", name:"NFL",        query:"NFL football",           color:"#4fa3ff", font:"'Bebas Neue',var(--font-head)", letterSpacing:2.5, service:"ESPN/Fox",   glow:"rgba(79,163,255,.3)" },
  { emoji:"🏀", name:"NBA",        query:"NBA basketball",         color:"#FF6B35", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"ESPN+/Max",  glow:"rgba(255,107,53,.35)" },
  { emoji:"⚾", name:"MLB",        query:"MLB baseball",           color:"#4a9eff", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"Apple TV+",  glow:"rgba(74,158,255,.3)" },
  { emoji:"🏒", name:"NHL",        query:"NHL hockey",             color:"#a0c4ff", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"ESPN+",      glow:"rgba(160,196,255,.3)" },
  { emoji:"⚽", name:"Soccer",     query:"soccer_hub",             color:"#4ade80", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"All Leagues",glow:"rgba(74,222,128,.3)" },
  { emoji:"🏎️",name:"Formula 1",  query:"Formula 1 racing",       color:"#ff4d6d", font:"'Bebas Neue',var(--font-head)", letterSpacing:1.5, service:"ESPN+",      glow:"rgba(255,77,109,.35)" },
  { emoji:"🏈", name:"College",    query:"college football NCAA",  color:"#fb923c", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"ESPN/Fox",   glow:"rgba(251,146,60,.35)" },
  { emoji:"🏊", name:"Olympics",   query:"Olympics sports",        color:"#60a5fa", font:"'Bebas Neue',var(--font-head)", letterSpacing:2,   service:"Peacock",    glow:"rgba(96,165,250,.3)" },
];
        ...
        {SPORT_CARDS.map(s=>{
          ...
          <button key={s.name} onClick={()=>onSearch(s.query)}
            style={{
              ...
              border:`1.5px solid ${hasFav ? s.color+"99" : "rgba(255,255,255,.08)"}`,
